...
class AdminCampaignPublish15Controller extends \crocodicstudio\crudbooster\controllers\CBController {
    ...
    public function cbInit() {
        ...
        $this->form = [];
        $this->form[] = ['label' => 'Campaign', 'name' => 'campaign_id', 'type' => 'select2', 'validation' => 'required|integer|min:0', 'width' => 'col-sm-10', 'datatable' => 'campaign,campaign_title'];
        $this->form[] = ['label' => 'Users', 'name' => 'user_id', 'multiple' => 'multiple', 'type' => 'select2', 'validation' => 'required|integer|min:0', 'width' => 'col-sm-10', 'datatable' => 'users,name'];
        # END FORM DO NOT REMOVE THIS LINE
        # OLD START FORM
        //$this->form = [];
        //$this->form[] = ["label"=>"Campaign Id","name"=>"campaign_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"campaign,campaign_title"];
...
//        visits increment by 1
        ...
        $data = Campaign::where('campaign_id', $campaign_id)->get();
        print_r($data);
        exit;
